package Lab09;
public class WinterApparel extends ApparelClass{

	public double season_profit, season_sale_price;

    public WinterApparel() {
    }
        
    
    public WinterApparel(double season_profit, double season_sale_price, String season_name, double season_price, double season_percent_discount, String product_name, double product_price, Date product_purchased_on, double product_percent_profit, double product_percent_discount) {
